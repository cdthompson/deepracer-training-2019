...
# CT: support for controlling physics
import rospy
...
def main():
    ...
    logger.info("Connecting to s3 boto data store at %s" % args.aws_endpoint_url)
    ds_params_instance = S3BotoDataStoreParameters(bucket_name=args.s3_bucket,
                                                   ...
                                                   s3_folder=args.s3_prefix, aws_endpoint_url=args.aws_endpoint_url)
