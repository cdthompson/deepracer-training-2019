...
class DeepRacerRolloutBackEnd(MemoryBackend):
    ...
    def __init__(self, params, num_consecutive_playing_steps):
        ...
        print("DeepRacerRolloutBackEnd: Connecting to redis at %s:%d" % (self.params.redis_address, self.params.redis_port))
        ...
        print("DeepRacerRolloutBackEnd: Subscribing to redis pubsub channel %s" % WORKER_CHANNEL)
...
class DeepRacerTrainerBackEnd(MemoryBackend):
    ...
    def __init__(self, params):
        ...
        # Redis client that will allow us to publish and subscribe to messages
        print("DeepRacerTrainerBackEnd: Connecting to redis at %s:%d" % (self.params.redis_address, self.params.redis_port))
        self.data_client = redis.Redis(self.params.redis_address, self.params.redis_port)
        ...
        print("DeepRacerTrainerBackEnd: Subscribing to redis pubsub channel %s" % self.params.channel)
