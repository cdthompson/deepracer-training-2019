...
def calculate_speed_factor(params):
  ...
  speed_factor = penalize_downshifting(params['speed'])
  speed_factor *= reward_upshifting(params['speed'])
...
def calculate_steering_factor(params):
  ...
  steering_factor = penalize_steering_change(params['steering_angle'])
