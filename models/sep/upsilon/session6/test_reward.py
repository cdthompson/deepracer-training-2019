...
class TestReward(unittest.TestCase):
  ...
  def test_race_line_heading(self):
    ...
    params['x'] = reward.OVAL_TRACK_RACE_LINE[6][0] 
    params['y'] = reward.OVAL_TRACK_RACE_LINE[6][1]
    params['heading'] = 0
    ...
    self.assertTrue(math.isclose(reward.race_line_heading(params), 0.0, abs_tol=1e-2))
    params['heading'] = 30
    self.assertTrue(math.isclose(reward.race_line_heading(params), 0.67, abs_tol=1e-2))
