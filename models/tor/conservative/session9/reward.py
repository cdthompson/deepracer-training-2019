...
# Raceline track
RACE_LINE_WAYPOINTS = REINVENT_BASE_RACE_LINE 
...
def reward_function(params):
  ...
  reward *= reinvent_hairpin_factor(params)

  return float(max(reward, 1e-3)) # make sure we never return exactly zero


#
# REINVENT ONLY - Stop fucking hitting the wall in turn 1
#
def reinvent_hairpin_factor(params):
    closest_waypoints = params['closest_waypoints']
    is_left_of_center = params['is_left_of_center']
    if closest_waypoints[0] > 19 and closest_waypoints[0] <= 25 and not is_left_of_center:
        return 1e-3
    else:
        return 2
