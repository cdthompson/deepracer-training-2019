...
WHEEL_FACTOR_WEIGHT = 0.5
WHEEL_FACTOR_EASING = 'linear'
HEADING_FACTOR_WEIGHT = 1.0
...
def reward_function(params):
  ...
  if DEBUG_LOG_ENABLED:
      print("REWARD_FACTORS: s: %0.2f, w: %0.2f, h: %0.2f, t: %0.2f, p: %0.2f, l: %0.2f r: %0.2f" %
...
def race_line_heading(params):
  ...
  heading_factor = 1.0 - heading_delta / 45.0
